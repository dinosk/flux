...
func (bc baseClient) GitRepoConfig(context.Context, bool) (v12.GitConfig, error) {
	return v12.GitConfig{}, remote.UpgradeNeededError(errors.New("GitRepoConfig method not implemented"))
}
